            ...
            <div className='container mx-auto '>
                ...
                <div className='mt-5 flex md:flex-row flex-col items-center justify-between'>
                    ...
                    <div className='md:w-1/2 md:mt-0 mt-5'>
                        <div className="text-4xl font-semibold mb-2">I'm Sarwar Azmain Eyafi</div>
                        <h1 className='text-2xl  text-white mb-3'><Typed
                            ...
                            loop
                        /></h1>
                        <p className='text-justify'>I am a Computer Science and Engineering graduate from Daffodil International
                            Unviversity. I have been working on Web Development field for about 2 years. I am a self
                            motivated quick learner. I am Proficient in latest client-side and server-side technologies. I work with ReactJS, React Native, Node.js, Express.js, MongoDB. I am interested in working with Blockchain, Cryptography, and Machine Learning.
                        </p>

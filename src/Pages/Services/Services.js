            ...
            <div className='container mx-auto '>
                ...
                <div className='mt-10 grid md:grid-cols-4 gap-5'>
                    ...
                    <div data-aos="fade-up" className="card  bg-base-100 shadow-xl image-full">
                        <figure><img src={spa} alt="Shoes" className='brightness-50' /></figure>
                    ...
                    <div data-aos="fade-down" className="card bg-base-100 shadow-xl image-full">
                        <figure><img src={fullstack} alt="Shoes" className='brightness-50' /></figure>
                        <div className="card-body">
                    ...
                    <div data-aos="fade-up" className="card  bg-base-100 shadow-xl image-full">
                        <figure><img src={frontend} alt="Shoes" className='brightness-50' /></figure>
                        <div className="card-body">
                            <h2 className="card-title">Mobile App Development</h2>
                            <p>I develop Cross Platform Mobile Application with amazing user experience, security and user friendly behaviour. </p>
